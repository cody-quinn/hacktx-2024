...
import { getRomsRomsGetOptions, createRoomRoomsPostMutation } from '../client/@tanstack/react-query.gen'
...
function CreateRoomForm() {
  ...
  return (
    <>
      ...
      <select onChange={(e) => setSelectedRom(e.target.value)} value={selectedRom}>
